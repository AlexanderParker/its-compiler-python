...
@pytest.fixture
def input_validator(security_config):
...
class TestInputValidator:
    ...
    def test_valid_template_structure(self, input_validator):
    ...
    def test_template_too_large(self, input_validator):
    ...
    def test_invalid_version_format(self, input_validator):
    ...
    def test_content_array_validation(self, input_validator):
    ...
    def test_too_many_content_elements(self, production_validator):
    ...
    def test_text_element_validation(self, input_validator):
    ...
    def test_text_content_too_large(self, input_validator):
    ...
    def test_placeholder_element_validation(self, input_validator):
    ...
    def test_conditional_element_validation(self, input_validator):
    ...
    def test_unknown_element_type(self, input_validator):
    ...
    def test_malicious_content_detection(self, input_validator):
    ...
    def test_suspicious_encoding_detection(self, input_validator):
    ...
    def test_variables_validation(self, input_validator):
    ...
    def test_variable_name_validation(self, input_validator):
    ...
    def test_variable_name_too_long(self, input_validator):
    ...
    def test_variable_value_validation(self, input_validator):
    ...
    def test_large_array_variable(self, input_validator):
    ...
    def test_object_nesting_depth(self, input_validator):
        """Test object nesting depth validation."""
        # Create deeply nested object
        nested_obj = {}
        current = nested_obj
        for i in range(15):  # Exceed depth limit
            current["nested"] = {}
    ...
    def test_extensions_validation(self, input_validator):
    ...
    def test_invalid_extension_url(self, input_validator):
    ...
    def test_custom_instruction_types_validation(self, input_validator):
    ...
    def test_custom_type_definition_validation(self, input_validator):
    ...
    def test_identifier_validation(self, input_validator):
    ...
    def test_identifier_too_long(self, input_validator):
    ...
    def test_nested_content_validation(self, input_validator):
    ...
    def test_sanitise_filename(self, input_validator):
    ...
    def test_dangerous_file_extension_sanitisation(self, input_validator):
    ...
    def test_filename_length_limit(self, input_validator):
    ...
    def test_get_validation_stats(self, input_validator):
    ...
    def test_config_object_validation(self, input_validator):
    ...
    def test_content_element_not_object(self, input_validator):
    ...
    def test_template_not_object(self, input_validator):
